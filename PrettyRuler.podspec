...
Pod::Spec.new do |s|
  ...
  s.name         = "PrettyRuler"
  s.version      = "2.0.0"
  s.summary      = "漂亮的自定义横向直尺控件，iOS7以上，刻度最小精度0.1，不足0.5时自减，大于0.5时自增"
  ...
  s.description  = "CAShapeLayer实现高效GPU渲染，漂亮的自定义横向直尺控件，iOS7以上，刻度最小精度0.1，不足0.5时自减，大于0.5时自增"
  ...
  s.author             = { "AsTryE" => "2846306067@qq.com" }
  # Or just: s.author    = "AsTryE"
  # s.authors            = { "AsTryE" => "2846306067@qq.com" }
